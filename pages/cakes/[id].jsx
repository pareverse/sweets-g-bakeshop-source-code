	...
	const addMutation = useMutation((data) => api.create('/carts', data), {
		onSuccess: () => {
			...
			toast({
				position: 'top',
				duration: 1000,
				render: () => <Toast title="Success" description="Cart added successfully." />
			})
		}
	})
				...
				<Flex flex={1} justify="center" align="center">
					<Flex direction="column" gap={6} w="full" maxW={364}>
						<Flex direction="column" gap={1}>
							<Text fontSize="2xl" fontWeight="semibold" textAlign="center" textTransform="capitalize" color="accent-1">
								{product.name}
							</Text>
