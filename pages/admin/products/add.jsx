...
import { AspectRatio, Button, chakra, Container, Flex, FormControl, FormErrorMessage, FormHelperText, FormLabel, Grid, GridItem, Icon, IconButton, Image, Input, InputGroup, InputLeftElement, Select, Text, Textarea, useToast } from '@chakra-ui/react'
							...
							<Card>
								<Flex direction="column" gap={6}>
									...
									<FormControl isInvalid={errors.description}>
										...
										<Textarea size="lg" minH={132} {...register('description', { required: true })}></Textarea>
										<FormErrorMessage>This field is required.</FormErrorMessage>
									</FormControl>
								</Flex>
							</Card>
								...
								<Flex direction="column" gap={6}>
									...
									{/* <FormControl>
										...
										<InputGroup>
											...
											<Input type="number" size="lg" {...register('percentage')} />
										</InputGroup>
									</FormControl> */}
								</Flex>
							</Card>
